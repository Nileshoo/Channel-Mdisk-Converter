...
API_ID = int(os.environ.get("API_ID", "9106985"))
API_HASH = os.environ.get("API_HASH", "8930f489b635070561b122b765d0572d")
BOT_TOKEN = os.environ.get("BOT_TOKEN", "6031223498:AAG5Jc3ya1TJZA2jgW4HMtCANcohQ8ykCOs")
DROPLINK_API = os.environ.get("DROPLINK_API")
MDISK_API = os.environ.get("MDISK_API", "Im2tIekrAqTcBDTAZU2g")
ADMINS = list(int(i.strip()) for i in os.environ.get("ADMINS").split(",")) if os.environ.get("1529116092") else []
DATABASE_NAME = os.environ.get("DATABASE_NAME", "MdiskConvertorBotpro")
DATABASE_URL = os.environ.get("DATABASE_URL", "mongodb+srv://Nilesh:<5quUVxFAWNfftkmU>@cluster0.wrhgicl.mongodb.net/?retryWrites=true&w=majority")
...
CHANNEL_ID = list(int(i.strip()) for i in os.environ.get("CHANNEL_ID").split("-1001896851822")) if os.environ.get("CHANNEL_ID") else []
